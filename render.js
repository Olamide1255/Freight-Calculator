...
const weightRates = {
  ...
  "Uganda Airlines": {
    "general": {
      "BJM": [125.05, 2.9, 2.75, 2.6, 2.25, 2, 1.85],
      "BOM": [125.05, 3.3, 3.15, 3, 2.65, 2.4, 2.25],
      "DAR": [125.05, 3, 2.85, 2.7, 2.35, 2.1, 1.95],
      "DXB": [125.05, 3.35, 3.2, 3.05, 2.7, 2.35, 2],
      "HRE": [125.05, 3.55, 3.4, 3.25, 2.95, 2.65, 2.45],//
      "FIH": [125.05, 3.3, 3.15, 3, 2.65, 2.4, 2.15],
      "JNB": [125.05, 3, 2.85, 2.7, 2.35, 2.1, 1.95],
      "JRO": [125.05, 2.9, 2.75, 2.6, 2.25, 2, 1.85],
      "LUN": [125.05, 3.55, 3.4, 3.15, 2.95, 2.75, 2.5],//
      "JUB": [125.05, 3.1, 2.95, 2.8, 2.45, 2.2, 2.05],
      "MBA": [125.05, 2.95, 2.8, 2.65, 2.3, 2.05, 1.9],
      "MGQ": [125.05, 3.35, 3.2, 3.05, 2.6, 2.45, 2.3],
      "NBO": [125.05, 3, 2.85, 2.6, 2.35, 2.1, 1.95],
      "ZNZ": [125.05, 3.2, 3.05, 2.9, 2.55, 2.3, 2.15]
},
    "dangerous": {
      "BJM": [300, 6.38, 6.05, 5.72, 4.95, 4.4, 4.07],
      "BOM": [300, 7.26, 6.93, 6.6, 5.83, 5.28, 4.95],
      "DAR": [300, 6.6, 6.27, 5.94, 5.17, 4.62, 4.29],
      "DXB": [300, 7.37, 7.04, 6.71, 5.94, 5.17, 4.31],
      "HRE": [300, 7.81, 7.48, 7.15, 6.49, 5.83, 5.39],//
      "FIH": [300, 7.26, 6.93, 6.52, 5.83, 5.28, 4.73],
      "JNB": [300, 6.6, 6.27, 5.94, 5.17, 4.62, 4.29],
      "JRO": [300, 6.38, 6.05, 5.72, 4.95, 4.4, 4.07],
      "LUN": [300, 7.81, 7.48, 6.93, 6.49, 6.05, 5.50],//
      "JUB": [300, 6.82, 6.49, 6.16, 5.39, 4.84, 4.51],
      "MBA": [300, 6.49, 6.16, 5.83, 5.06, 4.51, 4.18],
      "MGQ": [300, 7.37, 7.04, 6.71, 5.72, 5.39, 5.06],
      "NBO": [300, 6.6, 6.27, 5.72, 5.17, 4.62, 4.29],
      "ZNZ": [300, 7.04, 6.71, 6.38, 5.61, 5.06, 4.73]
},
//     "radioactive": {
